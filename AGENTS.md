...
These rules win over the OpenSpec skills in `.claude/skills/`. Those skills are
regenerated by `openspec update`, so they can't be edited to match — where they say
"think deeply", "brainstorm multiple approaches" or "use diagrams liberally", follow
